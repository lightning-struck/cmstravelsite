  ...
  const hotels = [
    {
      ...
      city: "Санья",
      stars: 5,
      images: ["/images/china.png", "/images/room.jpg"],
    },
    {
      name: "Отель Легенда",
      city: "Далянь",
      stars: 4,
      images: ["/images/hotel2.jpg", "/images/room2.jpg"],
    },
    {
      name: "Отель Восток",
      city: "Харбин",
      stars: 3,
      images: ["/images/hotel3.jpg", "/images/room2.jpg"],
    },
  ];
  ...
  return (
    <div className="gallery-page3">
      ...
      <Container>
        ...
        <h2>Наши отели для лучших клиентов</h2>
        <div className="gallery-container3">
        ...
        <h2>Фотографии наших клиентов</h2>
        <div className="gallery-container3">
